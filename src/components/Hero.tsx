        ...
        <div className="text-center space-y-8 animate-fade-in-up">
          <div className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight">
              <span className="relative inline-block bg-gradient-to-r from-primary via-white to-secondary bg-clip-text text-transparent bg-[length:200%_100%] animate-shimmer">
                Transforming Data
              </span>
              <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            <a
              href="#experience"
              className="px-8 py-4 border-2 border-primary text-white font-semibold rounded-lg hover:bg-primary/10 transition-all"
            >
              Experience
            </a>
          </div>
